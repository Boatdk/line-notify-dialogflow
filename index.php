...
$message_all = "K".$name_." ส่ง ".$message." "."https://line-notify-none-intent.herokuapp.com/push1-1.php?uid=".$userId."&&name=".$name_;
$mess = "K".$name_." ส่ง ".$message." "."https://line-notify-none-intent.herokuapp.com/push1-1.php?uid=".$userId."&&name=".$name_;
$date_ = date("Y-m-d");
$time_ = date("H:i:s");
...
//ADD header array
$headers = array( 'Content-type: application/x-www-form-urlencoded', 'Authorization: Bearer IznR59FVLcjvHwKlJdZQalRsni11ZGhd50VJ7biYuLG', );
